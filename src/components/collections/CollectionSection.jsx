...
export default function CollectionSection() {
  ...
  return (
    <section id="collections" className="bg-gradient-to-b from-black via-[#04142c] to-black px-6 py-32">
      {categories.map(({ key, title }) => (
        <div key={key} id={key} className="mb-32 max-w-7xl mx-auto scroll-mt-32">
